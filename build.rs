...
fn {}_test_{i}() {{
    ...
    let mut mod_rs = File::create(&suite_mod_file)
        .expect(&format!("Could not create {:?}", &suite_mod_file));

    mod_rs.write(b"// This file is auto-generated by the build script\n").unwrap();
    mod_rs.write(b"// Please, do not modify it manually\n").unwrap();
