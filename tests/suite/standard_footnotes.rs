...
#[test]
fn standard_footnotes_test_1() {
    let original = r##"Lorem ipsum.[^a]

[^a]: Cool.
"##;
    let expected = r##"<p>Lorem ipsum.<sup class="footnote-reference"><a href="#fn-a" id="fn-a-ref">1</a></sup></p>
...
"##;
    let expected = r##"<p>Songs that simply loop are a popular way to annoy people. <sup class="footnote-reference"><a href="#fn-examples" id="fn-examples-ref">1</a></sup></p>
<hr class="footnote-separator">
<section class="footnotes">
<ol class="footnotes-list">
...
Exciting![^lorem]
"##;
    let expected = r##"<p>Exciting! <sup class="footnote-reference"><a href="#fn-lorem" id="fn-lorem-ref">1</a></sup></p>
<hr class="footnote-separator">
<section class="footnotes">
<ol class="footnotes-list">
...
"##;
    let expected = r##"<p>Nested footnotes are considered poor style. <sup class="footnote-reference"><a href="#fn-a" id="fn-a-ref">1</a></sup> <sup class="footnote-reference"><a href="#fn-xkcd" id="fn-xkcd-ref">2</a></sup></p>
<blockquote>
...
"##;
    let expected = r##"<p><sup class="footnote-reference"><a href="#fn-Doh" id="fn-Doh-ref">1</a></sup> Ray Me Fa So La Te Do! <sup class="footnote-reference"><a href="#fn-1" id="fn-1-ref">2</a></sup></p>
<hr class="footnote-separator">
<section class="footnotes">
<ol class="footnotes-list">
